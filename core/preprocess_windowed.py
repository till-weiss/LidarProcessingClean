...
def create_chunks_from_wkt(target_geom_wkt, chunk_size=500, overlap=0.1):
    """
    Create grid chunks with overlap based on the bounding box of the target geometry.

    Returns two parallel lists:
      large_chunks – enlarged bboxes used for reading/filtering (reduces edge artefacts)
      orig_chunks  – true tile bboxes used for the final crop before writing
    """
